...
Response.Write([<html>]+ CRLF +;
   ...
   [<img src="bmp/images/newwave.jpg" align="left" style="position:absolute;left:0;top:0;">]+ CRLF +;
   [<!-- img src="bmp/images/wwToolLogo.jpg" style="position:absolute;left:0;top:0" -->]+ CRLF +;
...
Response.Write([]+ CRLF +;
   ...
   [<b>Welcome to Help Builder</b>,<br>]+ CRLF +;
   ...
   [<p>]+ CRLF +;
   [<img src="bmp/images/newproject.gif" border="0" align="left"> &nbsp;<b><a href="vfps://NOOPENPROJECT/CREATEPROJECT/">Create a new Project</a></b>]+ CRLF +;
   [<br>]+ CRLF +;
   [A project consists of a directory structure that contains a project file and the base templates and images.] + CRLF )
Response.Write([<br>]+ CRLF +;
   [<p>]+ CRLF +;
   [<img src="bmp/project.gif" border="0" align="left"> &nbsp;<b><a href="vfps://NOOPENPROJECT/OPENPROJECT">Open an existing Project</a></b>]+ CRLF +;
   [<br>]+ CRLF +;
...
Response.Write([]+ CRLF +;
   [<p>]+ CRLF +;
   [<img src="bmp/images/help.gif" border="0" align="left"> &nbsp;<b><a href="vfps://NOOPENPROJECT/SHOWHELP">View Help Builder Documentation</a></b>]+ CRLF +;
   [<br>]+ CRLF +;
   ...
   [<p>]+ CRLF +;
   [<img src="bmp/classheader.gif" border="0" align="left"> &nbsp;<b><a href="vfps://NOOPENPROJECT/SHOWSTEPBYSTEP">Take a Step by Step Tour</a></b>]+ CRLF +;
   [<br>]+ CRLF +;
...
Response.Write([help file.]+ CRLF +;
   [<p>]+ CRLF +;
   [<img src="bmp/weblink.gif" border="0" align="left"> &nbsp;<b><a href="http://www.west-wind.com/wwthreads/default.asp?forum=Html+Help+Builder" target="_wwSupport">Online Support</a></b>]+ CRLF +;
   [<br>]+ CRLF +;
   [Go to our online Message Board and ask a question, make a suggestion or otherwise]+ CRLF +;
